...
def diviseurs(n):
    for i in range(
        1, n + 1
    ):  # on parcourt tous les entiers de 1 a n pour trouver les diviseurs de n
...
print(
    "Le nombre entre 1 et 1000 dont la somme des diviseurs est la plus grande est:",
    q4_2(),
)
...
print(
    "Parmi les nombres entre 1 et 1000, celui qui a le temps de vol le plus long est:",
    q6(),
)
